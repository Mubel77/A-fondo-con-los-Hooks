...
function SearchMovies() {
    ...
    useEffect(() => {
        fetchData();
    }, [keyword]); // Se vuelve a llamar fetchData cuando keyword cambia
                    ...
                    <div className="row">
                        ...
                        {error ? (
                            ...
                            movies.length > 0 ? (
                                ...
                                <div className="alert alert-info text-center">No esta la pelicula buscada,.</div>
                            ))
                        }
                    </div>
                </>
